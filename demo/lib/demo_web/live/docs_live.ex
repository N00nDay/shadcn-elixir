defmodule DemoWeb.DocsLive do
  ...
  defp page_content(%{page: "theming"} = assigns) do
    ...
    <.code_block id="theme-default" language="css" source={Themes.base_theme("neutral")} />
    ...
    <.tabs id="theme-bases">
      ...
      <.tabs_content tabs="theme-bases" value="neutral" active>
        <.code_block id="theme-base-neutral" language="css" source={Themes.base_theme("neutral")} />
      </.tabs_content>
      <.tabs_content tabs="theme-bases" value="stone">
        <.code_block id="theme-base-stone" language="css" source={Themes.base_theme("stone")} />
      </.tabs_content>
      <.tabs_content tabs="theme-bases" value="zinc">
        <.code_block id="theme-base-zinc" language="css" source={Themes.base_theme("zinc")} />
      </.tabs_content>
      <.tabs_content tabs="theme-bases" value="gray">
        <.code_block id="theme-base-gray" language="css" source={Themes.base_theme("gray")} />
      </.tabs_content>
      <.tabs_content tabs="theme-bases" value="slate">
        <.code_block id="theme-base-slate" language="css" source={Themes.base_theme("slate")} />
      </.tabs_content>
    </.tabs>
    """
  end
